...
begin
    ...
    process(A, B, adder_result, overflow, twos_comp_result)
...
--            inverted_result := not adder_result; -- NOT 결과
--            abs_temp := to_integer(unsigned(std_logic_vector(unsigned(inverted_result) + 1))); -- 2의 보수 처리
